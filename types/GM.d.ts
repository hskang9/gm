...
interface GMInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setSVG(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "SVG", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "setSVG", values: [string]): string;
  encodeFunctionData(
...
export class GM extends BaseContract {
  ...
  functions: {
    ...
    SVG(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    setSVG(svg_: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    SVG(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    SVG(overrides?: CallOverrides): Promise<PopulatedTransaction>;
